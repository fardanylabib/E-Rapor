...
import {querySiswa,handlePopup} from '../../store/Actions';
...
const popupString = [
    ...
    {index:1,content:'data siswa tersebut?'},   
];
...
class CustomPaginationActionsTable extends React.Component {
  ...
  render() {
    ...
    const dataRow = this.props.siswa;
        ...
        return (
            ...
            <div className={classes.tableWrapper}>
                ...
                <TableHead>
                    ...
                    <CustomTableCell >Nama Siswa</CustomTableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {
                    //sesi, siswa, kelas, mapel, murid}
            ...
            <Fab aria-label="Add" className={classes.refreshBtn} onClick={this.props.querySiswa}>
                <RefreshIcon />
            </Fab>
            <PopupWindow/>
            </div>
...
const DaftarSiswa = withStyles(styles)(CustomPaginationActionsTable);
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({querySiswa,handlePopup},dispatch);
}
